...
@XmlType(name = "generaRegistroDocumentoResponse", propOrder = {
...
public class GeneraRegistroDocumentoResponse
    extends RespuestaDTO
{
	...
	public String toString() {
		return "GeneraRegistroDocumentoResponse [codDivisionUnidadSGDP=" + codDivisionUnidadSGDP + ", codTipoDoc="
