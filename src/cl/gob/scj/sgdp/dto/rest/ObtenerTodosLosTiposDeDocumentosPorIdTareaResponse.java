...
public class ObtenerTodosLosTiposDeDocumentosPorIdTareaResponse {
	...
	public String toString() {
		return "ObtenerTodosLosTiposDeDocumentosPorIdTareaResponse [listaTipoDeDocumento=" + listaTipoDeDocumento
				+ ", mensaje=" + mensaje + ", detalleRespuesta=" + detalleRespuesta + "]";
	}
