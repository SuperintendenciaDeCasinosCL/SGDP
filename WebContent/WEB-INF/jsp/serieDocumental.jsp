	...
	<div class="container-fluid container-sgdp">
		...
		<div class="row content">
			...
			<div class="col-sm-10">
				...
				<c:set var="mensajeIndicador" value="Mantenedor de series documentales" />
				...
				<div class="col-sm-12" id="IndicadorCuerpo">
					...
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/services/InitialData.js" />'></script>
					
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/components/Container.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/components/SerieForm.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/components/Lista.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/components/ListaDocumentos.js" />'></script>
						
					<script type="text/javascript"	src='<c:url value="js/serieDocumental/main.js" />'></script>
