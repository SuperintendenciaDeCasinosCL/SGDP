			    ...
			    <div class="col-sm-10">	
			    	...
			    	<c:choose>
						<c:when test = "${usuario.fueraDeOficina eq true}">
							<c:set var="colorBackHeaderMantenedorUnidadaesOP" value="#FFD51D" />
							<c:set var="mensajeMantenedorUnidadaes" value="Mantenedor de Unidades (Fuera de Oficina)" />
						</c:when>
						<c:otherwise>
							<c:set var="colorBackHeaderMantenedorUnidadaesOP" value="#41CAC0" />
							<c:set var="mensajeMantenedorUnidadaesOP" value="Mantenedor de Unidades Operativas" />							
						</c:otherwise>						
					</c:choose> 
					...
					<div id="divBackHeaderMantenedorParametros" class="row div-area-trabajo-cab" style="background-color: ${colorBackHeaderMantenedorUnidadaesOP}; color: #fff;">
			    		...
			    		<div class="col-sm-9"><h2 id="h2MensajeMantenedorUnidadesOP">${mensajeMantenedorUnidadaesOP}</h2></div>
		      		...
		      		<hr>
   					...
   					<div class="col-sm-12" id="mantenedorUnidadesOperativasCuerpo">
   						
				    	<c:import url="/WEB-INF/jsp/div/mantenedorUnidadesOperativasCuerpo.jsp"></c:import>
