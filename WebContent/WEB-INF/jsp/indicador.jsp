			    ...
			    <div class="col-sm-10">	
			    	...
			    	<c:choose>
						<c:when test = "${usuario.fueraDeOficina eq true}">
							<c:set var="colorBackHeaderIndicador" value="#FFD51D" />
							<c:set var="mensajeIndicador" value="Indicador (Fuera de Oficina)" />
						</c:when>
						<c:otherwise>
							<c:set var="colorBackHeaderIndicador" value="#41CAC0" />
							<c:set var="mensajeIndicador" value="Indicador" />							
						</c:otherwise>						
					</c:choose> 
					...
					<div id="divBackHeaderIndicador" class="row" style="background-color: ${colorBackHeaderIndicador}; color: #fff;">
			    		...
			    		<div class="col-sm-9"><h2 id="h2MensajeIndicador">${mensajeIndicador}</h2></div>
		      		...
		      		<hr>
   					...
   					<div class="col-sm-12" id="IndicadorCuerpo">
				         <c:import url="/WEB-INF/jsp/div/indicadorCuerpo.jsp"></c:import>				
					</div>  
