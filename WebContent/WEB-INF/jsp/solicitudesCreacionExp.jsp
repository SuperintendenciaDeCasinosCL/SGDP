			    ...
			    <div class="col-sm-10">	
			    	...
			    	<c:choose>
						<c:when test = "${usuario.fueraDeOficina eq true}">
							<c:set var="colorBackHeaderSolicitudesCreacionExp" value="#FFD51D" />
							<c:set var="mensajeSolicitudesCreacionExp" value="Solicitudes de creaci&oacute;n de expedientes (Fuera de Oficina)" />
						</c:when>
						<c:otherwise>
							<c:set var="colorBackHeaderSolicitudesCreacionExp" value="#41CAC0" />
							<c:set var="mensajeSolicitudesCreacionExp" value="Solicitudes de creaci&oacute;n de expedientes" />							
						</c:otherwise>						
					</c:choose> 
					...
					<div id="divBackHeaderSolicitudesCreacionExp" class="row div-area-trabajo-cab" style="background-color: ${colorBackHeaderSolicitudesCreacionExp}; color: #fff;">
			    		...
			    		<div class="col-sm-9"><h2 id="h2MensajeSolicitudesCreacionExp">${mensajeSolicitudesCreacionExp}</h2></div>
