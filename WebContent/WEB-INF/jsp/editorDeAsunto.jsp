	...
	<div class="container-fluid container-sgdp">
		...
		<div class="row content">
			...
			<div class="col-sm-10">
				...
				<c:set var="mensajeIndicador" value="Editor asunto" />
				...
				<div class="col-sm-12" id="IndicadorCuerpo">
					...
					<script type="text/javascript"	src='<c:url value="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js" />'></script>
 					...
 					<script type="text/javascript"	src='<c:url value="js/editorAsunto/services/dataService.js" />'></script>

					<script type="text/javascript"	src='<c:url value="js/editorAsunto/components/Container.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/editorAsunto/components/Formulario.js" />'></script>

					<script type="text/javascript"	src='<c:url value="js/editorAsunto/main.js" />'></script>
