							...
							<div class="container-fluid container-sgdp" id="contenedorBEPrincipal">
								...
								<div class="row content">
									...
									<div id="divBackHeaderAreaDeTrabajo" class="row div-area-trabajo-cab" style="background-color: ${colorBackHeaderAreaDeTrabajo}; color: #fff;">
										...
										<div class="col-sm-10">
											<h2 id="h2MensajeAreaDeTrabajo">${mensajeAreaDeTrabajo}</h2>
										</div>
									...
									<div class="col-sm-12">
										...
										<c:if test="${permisos[permisoCrearExpediente] eq permisoCrearExpediente}">
											<button type="button" class="btn btn-primary" id="crearExpediente" onclick="abrirCrearExpediente()">
												...
												<spring:message code="bandejaDeEntrada.boton.crearExpediente.nombre" />
											</button>
										</c:if>
										<!--  
										...
										<div class="button-group pull-right">
											...
											<ul class="dropdown-menu pull-right">
												...
												<li class="centrarTextoBoton"><button type="button" class="btn btn-primary tamanioBotonFiltro" id="filtarExpediente" onclick="filtrarExpediente()">
														Filtrar
													</button></li>
											</ul>
										</div>
								...
								<%-- Corresponde al div <div class="embed-responsive embed-responsive-16by9 row hide" id="iframeDivDetalleDeTarea">
							</div>
							--%>
									...
									<c:if test="${permisos[permisoPuedeVerTareasEnEjecucion] eq permisoPuedeVerTareasEnEjecucion}">
										<div class="row">
											<div class="col-sm-12" id="tareasEnEjecucion">
												<%--<c:import url="/WEB-INF/jsp/div/tareasEnEjecucion.jsp">
													</c:import>--%>
											</div>
										</div>
									</c:if>
											...
											<div id="wrapper">
												...
												<div class="col-sm-9">
													...
													<div class="row" style="background-color: #41CAC0; color: #fff;">
														...
														<div class="col-sm-5">
															<h3>
																<spring:message code="bandejaDeEntrada.cabecera.nombre" />
															</h3>
														</div>
