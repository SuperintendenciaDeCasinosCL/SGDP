										...
										<c:choose>
											...
											<c:when test="${instanciaDeTareaDTO.procesoTieneRdsSnc eq true}">
												...
												<td class="view-message subproceso-rds-snc">
													<a class="btn btn-link btn-wrap-break" id="${instanciaDeTareaDTO.idInstanciaDeTarea}LinkProceso"
														...
														<spring:message code="bandejaDeEntrada.tabla.tareas.esRDSNC" />&nbsp;${instanciaDeTareaDTO.nombreDeProceso}
													</a>
												</td>
											...
											<c:otherwise>
												...
												<td class="view-message">
													<a class="btn btn-link btn-wrap-break" id="${instanciaDeTareaDTO.idInstanciaDeTarea}LinkProceso"
														onclick='cargaDetalleDeTarea("${instanciaDeTareaDTO.nombreExpediente}","${instanciaDeTareaDTO.idInstanciaDeTarea}", "true", "${instanciaDeTareaDTO.idExpediente}", "${instanciaDeTareaDTO.urlControl}")'>${instanciaDeTareaDTO.nombreDeProceso}</a>
												</td>
