	...
	<div class="container-fluid container-sgdp">
		...
		<div class="row content">
			...
			<div class="col-sm-10">
				...
				<c:set var="mensajeIndicador" value="Reportes" />
				...
				<div class="col-sm-12" id="IndicadorCuerpo">
					...
					<script type="text/javascript"	src='<c:url value="js/reportes/repos/headers.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/reportes/services/RepoServices.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/reportes/components/Container.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/reportes/components/ReporteTareas.js" />'></script>
					<script type="text/javascript"	src='<c:url value="js/reportes/main.js" />'></script>
